...
def update_bullets(aliens, bullets, game_settings, screen, ship):
    """Update bullets position and remove old bullets"""
    bullets.update()
    for bullet in bullets.copy():
        if bullet.rect.bottom <= 0:
            bullets.remove(bullet)
    check_alien_collisons(aliens, bullets, game_settings, screen, ship)

def check_alien_collisons(aliens, bullets, game_settings, screen, ship):
...
def create_fleet(game_settings, screen, ship, aliens):
    """Create alines fleet"""
    # Create alien and compute how much aliens can exists at the row
    alien = Alien(game_settings, screen)
...
def update_aliens(game_settings, aliens, stats, ship, screen, bullets):
